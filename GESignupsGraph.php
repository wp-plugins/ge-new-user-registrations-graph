<?php
/*
Plugin Name: GE New User Registrations Graph
Plugin URI: http://www.giveaway.expert
Description: A dashbaord widget to show a graph of new user registrations per day
Version: 1.0
Author: Giveaway Expert
Author URI: http://www.giveaway.expert
License: GPLv2
*/

add_action('wp_dashboard_setup', array('GE_Signups_Graph_Widget','init') );

class GE_Signups_Graph_Widget {

    /**
     * The id of this widget.
     */
    const wid = 'ge_signups_graph_widget';
    ...
    public static function init() {
        ...
        wp_add_dashboard_widget(
            ...
            __( 'New User Registrations', 'nouveau' ),//Visible name for the widget
            array('GE_Signups_Graph_Widget','widget'),      //Callback for the main widget content
            array('GE_Signups_Graph_Widget','config')       //Optional callback for widget configuration content
        );
    }
